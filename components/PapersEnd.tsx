        ...
        <div className="mt-8 space-y-3 sm:mt-10">
          {papers.map((item, idx) => (
            <motion.a
              ...
              className="flex items-start gap-3 rounded-2xl bg-white/90 px-4 py-4 no-underline shadow-sm transition hover:bg-white sm:gap-4 sm:px-5 sm:py-4"
            >
